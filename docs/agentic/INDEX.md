...
| Anulaciones / notas credito (devoluciones, reclamos, reembolsos) | `docs/agentic/modules/anulaciones-nc.md` | `app/services/anulaciones_db.py`, `anulaciones_motor.py`, `app/services/alegra.py`, `app/tools/anulaciones.py`, `app/meli_webhook_topics.py`, `scripts/anulaciones_cron.py` | `pytest tests/test_notas_credito.py`, `balance_comprobacion()["cuadra"]`, dry-run sobre copia de `contabilidad.db` |
