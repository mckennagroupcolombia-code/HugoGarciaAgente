...
export const MCK_UI_PATHS: Record<string, ReactNode> = {
  ...
  globe: (
    <><circle cx="12" cy="12" r="8.5" /><path d="M3.5 12h17" /><path d="M12 3.5c2.6 2.4 3.8 5.2 3.8 8.5s-1.2 6.1-3.8 8.5c-2.6-2.4-3.8-5.2-3.8-8.5s1.2-6.1 3.8-8.5z" /></>
  ),
  sparkle: (
    <><path d="M12 4l1.8 5.2L19 11l-5.2 1.8L12 18l-1.8-5.2L5 11l5.2-1.8z" /><path d="M18.5 4v3M17 5.5h3" /></>
  ),
  trophy: (
    <><path d="M8 4h8v5a4 4 0 0 1-8 0z" /><path d="M8 6H5a3 3 0 0 0 3 4M16 6h3a3 3 0 0 1-3 4" /><path d="M12 13v4M9 20h6M10 17h4" /></>
  ),
  bag: (
    <><path d="M6 8h12l1 12H5z" /><path d="M9 8V7a3 3 0 0 1 6 0v1" /></>
  ),
  bottle: (
    <><path d="M10 3h4v3l2 3v10a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2V9l2-3z" /><path d="M8 13h8" /></>
  ),
  cap: (
    <><path d="M5 10h14v4a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2z" /><path d="M7 10V8h10v2" /><path d="M9 12v2M12 12v2M15 12v2" /></>
  ),
  spoon: (
    <><ellipse cx="8.5" cy="7.5" rx="3.5" ry="4.5" transform="rotate(-45 8.5 7.5)" /><path d="M11.5 10.5L20 19" /></>
  ),
  shield: (
    <><path d="M12 3l7 3v5c0 4.5-3 8-7 10-4-2-7-5.5-7-10V6z" /><path d="M9 12l2 2 4-4" /></>
  ),
  puzzle: (
    <><path d="M5 9h3.5a2 2 0 1 1 3.5 0H15v3.5a2 2 0 1 0 0 3.5V19H5z" /></>
  ),
  bulb: (
    <><path d="M9 17h6M10 20h4" /><path d="M8.5 14a5.5 5.5 0 1 1 7 0c-.7.7-1 1.5-1 3h-5c0-1.5-.3-2.3-1-3z" /></>
  ),
  coins: (
    <><ellipse cx="9" cy="8" rx="5" ry="2.5" /><path d="M4 8v4c0 1.4 2.200 2.5 5 2.5" /><ellipse cx="15" cy="14" rx="5" ry="2.5" /><path d="M10 14v3c0 1.4 2.200 2.5 5 2.5s5-1.1 5-2.5v-3" /></>
  ),
  ruler: (
    <><path d="M4 16L16 4l4 4L8 20z" /><path d="M8 12l1.5 1.5M11 9l1.5 1.5M14 6l1.5 1.5" /></>
  ),
  compass: (
  ...
  scale: (
    <><path d="M12 4v16M8 20h8M5 7h14" /><path d="M5 7l-2.5 6a2.5 2.5 0 0 0 5 0zM19 7l-2.5 6a2.5 2.5 0 0 0 5 0z" /></>
  ),
  hand: (
    <><path d="M8 12V6a1.5 1.5 0 0 1 3 0v5M11 11V4.5a1.5 1.5 0 0 1 3 0V11M14 11V6a1.5 1.5 0 0 1 3 0v8a6 6 0 0 1-6 6c-2.5 0-4-1-5.5-3.5L4 13.5a1.5 1.5 0 0 1 2.5-1.5L8 13.5" /></>
  ),
  broom: (
    <><path d="M19 4l-7 7" /><path d="M9.5 10.5l4 4L10 20H4l1-6z" /><path d="M7 15l3 3" /></>
  ),
};
